...
public final class EnumProjectInfoBuilderRef<T> implements ProjectInfoBuilder2<T> {
    ...
    public EnumProjectInfoBuilderRef(
        ...
        this.wrappedRef = new AtomicReference<>(null);
    }
    ...
    private static final class SerializedFormat implements Serializable {
        ...
        private Object readResolve() throws ObjectStreamException {
            return wrappedConstName != null
                    ? new EnumProjectInfoBuilderRef<>(modelType, wrappedTypeName, wrappedConstName)
                    : new EnumProjectInfoBuilderRef<>(modelType, wrappedTypeName);
        }
    }
}
